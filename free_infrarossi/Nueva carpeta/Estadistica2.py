...
class Estadistica:
	...
	self.k = np.ceil(1 + np.log2(self.n))
	self.c = np.sort(self.y)
...
#	    print a1, c1 
	...
	def Inter1():
	    ...
	    np.savetxt('marca1.dat', column_stack((X,Y)), fmt=('%6.3f', '%6.3f'))
	    np.savetxt('marca2.dat', column_stack((X1,Y1)), fmt=('%6.3f', '%6.3f'))
	...
	def Inter2():
	    ...
	    X1 = round(float(np.sum(x1)/xp1), 4)
	    Y1 = round(float(np.sum(y1)/yp1), 4)
	    np.savetxt('marca3.dat', column_stack((X,Y)), fmt=('%6.3f', '%6.3f'))
	    np.savetxt('marca4.dat', column_stack((X1,Y1)), fmt=('%6.3f', '%6.3f'))
	...
	def Inter3():
	    ...
	    X1 = round(float(np.sum(x1)/xp1), 4)
	    Y1 = round(float(np.sum(y1)/yp1), 4)
	    np.savetxt('marca5.dat', column_stack((X,Y)), fmt=('%6.3f', '%6.3f'))
	    np.savetxt('marca6.dat', column_stack((X1,Y1)), fmt=('%6.3f', '%6.3f'))
