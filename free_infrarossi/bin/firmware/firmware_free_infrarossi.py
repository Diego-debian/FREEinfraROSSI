...
class Firmware:
	...
	archi.write("\n")
	archi.write("CARGA=`avrdude -F -V -c arduino -p ATMEGA328P -b 115200 -U flash:w:bin/firmware/infrarossi.hex -P ")
...
#	archi.write("echo firmware instalado correctamente")
	...
	archi.close()
	time.sleep(1)
	os.system("xterm -T infrarossi -geom 82x27+0+55 +cm -bg blue -e 'sh bin/firmware/a_carga.sh' &")
	time.sleep(8)
