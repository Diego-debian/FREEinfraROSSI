...
class o_Carpetas:
	...
	time.sleep(3)
        ...
        shutil.move("datos/Amplitud.dat",  self.Carpeta)
        shutil.move("datos/BY.dat",  self.Carpeta)
        shutil.move("datos/ECM1.dat",  self.Carpeta)
        shutil.move("datos/q1.dat",  self.Carpeta)
        shutil.move("datos/Transmitancia.dat",  self.Carpeta)
        shutil.move("datos/V_aproximado.dat",  self.Carpeta)
        shutil.move("datos/Vteo.dat",  self.Carpeta)
        ...
        shutil.move("datos/Absorcion.png",  self.Carpeta)
	os.system("sh bin/m_Carpeta2.sh")
